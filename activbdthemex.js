$(document).ready(function () {
  ...
  $("#data-count").each(function () {
    ...
    $.ajax({url: _0x1cdf27 + "/feeds/posts/default/-/" + _0x1ca25f + "?alt=json-in-script", type: "get", dataType: "jsonp", success: function (_0x416c1a) {
  ...
  $(".licenses").each(function () {
    ...
    $.ajax({url: _0x30dd60 + "/feeds/posts/default" + _0x4d5e8b + "?alt=json-in-script", type: "get", dataType: "jsonp", success: function (_0x55846f) {
      var _0x19f98c = "";
      var _0x3c2bd9 = '<ul id="licenses" style="display:none!important">';
      for (var _0x164aae = 0; _0x164aae < _0x55846f.feed.entry.length; _0x164aae++) {
        for (var _0x59c50e = 0; _0x59c50e < _0x55846f.feed.entry[_0x164aae].link.length; _0x59c50e++) {
        ...
        for (var _0x4e0947 = 0; _0x4e0947 < _0x55846f.feed.entry[_0x164aae].category.length; _0x4e0947++) {
